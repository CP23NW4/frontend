...
<template>
  <div
    ...
    class="mx-8 md:mx-4 lg:mx-4 mb-10 text-left block max-w-sm bg-white border border-gray-200 shadow-md hover:shadow-lg transition-transform transform hover:-translate-y-1 focus:translate-y-0 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
  >
    ...
    <div class="flex items-center p-5">
      <img
        v-if="
          strayAnimal &&
          strayAnimal.gender &&
          strayAnimal.gender.toUpperCase() === 'FEMALE'
        "
        src="/female.svg"
        class="h-5 mr-4"
        alt="Female Icon"
      ...
      <img
        v-if="
          strayAnimal &&
          strayAnimal.gender &&
          strayAnimal.gender.toUpperCase() === 'MALE'
        "
        src="/male.svg"
        class="h-5 mr-4"
        alt="Male Icon"
      ...
      <div class="flex flex-col">
        ...
        <div
          class="text-sm leading-none tracking-tight mt-1"
        ...
        >
          {{
            strayAnimal.description && strayAnimal.description.length < 20
              ...
              : strayAnimal.description
              ? strayAnimal.description.substring(0, 20) + " ..."
              : ""
          }}
        </div>
        <div
        ...
        <div
          class="text-[16px] font-bold leading-none tracking-tight text-emerald-600"
          v-if="strayAnimal.status === 'Available'"
        >
          {{ strayAnimal.status }}
        </div>
        <div
          class="text-[16px] font-bold leading-none tracking-tight text-red-600"
